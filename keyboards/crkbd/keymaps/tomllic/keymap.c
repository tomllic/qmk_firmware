...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                       GUI_T(KC_DEL), MO(LOWER), KC_SPC,     SFT_T(KC_ENT),   MO(RAISE), KC_LALT
                                      //`--------------------------'  `--------------------------'
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   KC_F4,   KC_F5,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_P, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_BSPC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0, XXXXXXX, 
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     KC_PPLS, KC_PMNS, KC_PAST, KC_DOT, KC_PSLS, KC_EQL,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_DEL, _______, KC_SPC,    KC_ENT,   MO(ADJUST), XXXXXXX
                                      //`--------------------------'  `--------------------------'
  ),
...
LCTL(KC_BSLS), KC_QUOT,XXXXXXX, KC_EQL, LCTL(KC_DOT), KC_TILD,                    XXXXXXX, XXXXXXX, KC_COMM,  KC_DOT, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_DEL,   MO(ADJUST),  KC_SPC,   KC_ENT, _______, XXXXXXX
                                      //`--------------------------'  `--------------------------'
  ),
...
void rgb_matrix_indicators_user(void) {
	...
	rgb_matrix_set_color(40, 255, 0, 0); //layer switch right
...
//  switch(biton32(state)) {
 //   case ADJUST:
//      rgb_matrix_set_color(36, 255, 0, 0); //reset button
//      break;
    //default:
